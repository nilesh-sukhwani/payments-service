...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["godrejagrovet.com"])
...
# STATIC
# ------------------------
STATICFILES_STORAGE = "payment_service.utils.storages.StaticRootAzureStorage"
STATIC_URL = f"https://{AZURE_ACCOUNT_NAME}.blob.core.windows.net/static/"
# MEDIA
# ------------------------------------------------------------------------------
DEFAULT_FILE_STORAGE = "payment_service.utils.storages.MediaRootAzureStorage"
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="payments-service <noreply@godrejagrovet.com>",
)
...
SPECTACULAR_SETTINGS["SERVERS"] = [  # noqa F405
    {"url": "https://godrejagrovet.com", "description": "Production server"}
]
# Your stuff...
# ------------------------------------------------------------------------------
